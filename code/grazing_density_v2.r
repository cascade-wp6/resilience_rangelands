...
# vulnerability_ 
parms_temp$vul <- sum((1-parms_temp$Q_plus)[x_new$cells == "+" & (1-parms_temp$Q_plus) > 0])#/(width*height)
parms_temp$vul3 <- sum((1-parms_temp$Q_plus)[x_new$cells == "+"])
parms_temp$vul2 <- (1-mean(parms_temp$Q_plus[x_new$cells == "+" & (1-parms_temp$Q_plus) > 0]))*parms_temp$rho
...
result$assoc3[i] <-  mean(with(parms_temp, (g/0.5*(1-Q_plus)/vul * result$n[i]))[x_new$cells == "+"]  )  
result$assoc3_4n[i] <-  mean(with(parms_temp, (g/0.5*(1-Q_plus)/vul * result$n[i] ))[x_new$cells == "+" & (1-parms_temp$Q_plus) == 1]  ) 
result$assoc3_3n[i] <-  mean(with(parms_temp, (g/0.5*(1-Q_plus)/vul * result$n[i] ))[x_new$cells == "+" & (1-parms_temp$Q_plus) == 3/4]  ) 
result$assoc3_2n[i] <-  mean(with(parms_temp, (g/0.5*(1-Q_plus)/vul * result$n[i] ))[x_new$cells == "+" & (1-parms_temp$Q_plus) == 2/4]  ) 
result$assoc3_1n[i] <-  mean(with(parms_temp, (g/0.5*(1-Q_plus)/vul * result$n[i] ))[x_new$cells == "+" & (1-parms_temp$Q_plus) == 1/4]  )  
result$assoc3_0n[i] <-  mean(with(parms_temp, (g/0.5*(1-Q_plus)/vul * result$n[i] ))[x_new$cells == "+" & (1-parms_temp$Q_plus) == 0]  )

result$stockassoc3[i] <-  mean(with(parms_temp, (g/rho*(1-Q_plus)/vul * result$n[i]))[x_new$cells == "+"]  )  
result$stockassoc3_4n[i] <-  mean(with(parms_temp, (g/rho*(1-Q_plus)/vul * result$n[i] ))[x_new$cells == "+" & (1-parms_temp$Q_plus) == 4/4]  ) 
result$stockassoc3_3n[i] <-  mean(with(parms_temp, (g/rho*(1-Q_plus)/vul * result$n[i] ))[x_new$cells == "+" & (1-parms_temp$Q_plus) == 3/4]  ) 
result$stockassoc3_2n[i] <-  mean(with(parms_temp, (g/rho*(1-Q_plus)/vul * result$n[i] ))[x_new$cells == "+" & (1-parms_temp$Q_plus) == 2/4]  ) 
result$stockassoc3_1n[i] <-  mean(with(parms_temp, (g/rho*(1-Q_plus)/vul * result$n[i] ))[x_new$cells == "+" & (1-parms_temp$Q_plus) == 1/4]  )  
result$stockassoc3_0n[i] <-  mean(with(parms_temp, (g/rho*(1-Q_plus)/vul * result$n[i] ))[x_new$cells == "+" & (1-parms_temp$Q_plus) == 0]  )
