...
result$fit$summary <- rbind(result$fit$summary, data.frame(
		...
		p1 = result$fit[[result$fit$best[k]]][k,2],
		p2 = result$fit[[result$fit$best[k]]][k,3],
		p3 = result$fit[[result$fit$best[k]]][k,4],		
		p1_p = result$fit[[result$fit$best[k]]][k,5],
		p2_p = result$fit[[result$fit$best[k]]][k,6],
		p3_p = result$fit[[result$fit$best[k]]][k,7]
		)
		)
