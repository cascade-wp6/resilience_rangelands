...
snapshots <- c(1, 400, 450, 500, 900, 950, 1000)/delta+1
...
with(data = output[output$grazing == 0.05,], plot(environmt, rho_plus, xlim = c(0,1), ylim = c(0,1), pch = 20))
with(data = output[output$grazing == 0.15,], plot(environmt, rho_plus, xlim = c(0,1), ylim = c(0,1), pch = 20))
with(data = output[output$grazing == 0.25,], plot(environmt, rho_plus, xlim = c(0,1), ylim = c(0,1), pch = 20))
dev.off()
