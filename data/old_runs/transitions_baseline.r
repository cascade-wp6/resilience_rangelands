...
with(data = output[output$grazing == 0.005,], points(environmt, rho_plus, pch = 20, col = cols[2]))
with(data = output[output$grazing == 0.015,], points(environmt, rho_plus, pch = 20, col = cols[3]))
with(data = output[output$grazing == 0.025,], points(environmt, rho_plus, pch = 20, col = cols[4]))

with(data = output[output$grazing == 0,], plot(environmt, q_plus, xlim = c(0,1), ylim = c(0,1), pch = 20))
with(data = output[output$grazing == 0.005,], points(environmt, q_plus, pch = 20, col = cols[2]))
with(data = output[output$grazing == 0.015,], points(environmt, q_plus, pch = 20, col = cols[3]))
with(data = output[output$grazing == 0.025,], points(environmt, q_plus, pch = 20, col = cols[4]))

with(data = output[output$grazing == 0,], plot(environmt, mortality, xlim = c(0,1), ylim = c(0,1), pch = 20))
with(data = output[output$grazing == 0.005,], points(environmt, mortality, pch = 20, col = cols[2]))
with(data = output[output$grazing == 0.015,], points(environmt, mortality, pch = 20, col = cols[3]))
with(data = output[output$grazing == 0.025,], points(environmt, mortality, pch = 20, col = cols[4]))
