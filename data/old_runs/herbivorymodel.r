...
pdf("herbivory_intermediate.pdf", width = 12, height = 6, paper = "special" )
...
png("herbivory_heterogenous.png", width = 450, height = 450)
par(mar = c(0,0,0,0))
		x <- result$timeseries[[9001]]
...
pdf("herbivory_patchsizedist.pdf", width = 12, height = 6, paper = "special" )
...
, movie.name = "herbivory_intermediate.gif", img.name = "grid", convert = "convert", interval = 0.01/1,
