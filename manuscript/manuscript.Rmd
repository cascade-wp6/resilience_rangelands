...
- The conceptualisation of rangelands as systems that can experience abrupt shifts between alternative stable states has been happening since the 70s (Noy Meir, Holling, May). 
...
Figure 3 | 3D graph of growth vs. mortality 
...
- To investigate the role of local interactions between plants, we implement these mechanisms into the model. This is complemented with figures. 
