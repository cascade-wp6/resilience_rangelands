...
plot_bifurcation(livestock, over = "L", xrange = c(0,2), res = 201, parms = p) -> out
```
...
p <- set_parms(livestock$parms, set = list(b = 0.3, c = 0.4, f = 0.9, p = 0.99, v = 0.99))
plot_pairapproximation3D(livestock, parms = p) -> out
```
...
We chose to keep the first two, substitute and simplify
<!--
