...
```{r, echo = FALSE, fig.cap="", fig.height = 2}
...
parms$f = 1
bifurcation(parms, pairapprox = TRUE, meanfield = FALSE, "b", c(0,1)) -> out_1

parms$f = 0.5
bifurcation(parms, pairapprox = TRUE, meanfield = FALSE, "b", c(0,1), add =TRUE) -> out_2

parms$f = 0
bifurcation(parms, pairapprox = TRUE, meanfield = FALSE, "b", c(0,1), add =TRUE) -> out_3


###

parms$f = 1
bifurcation(parms, pairapprox = TRUE, meanfield = FALSE, "L", c(0,12))-> out_4
 
parms$f = 0.5
bifurcation(parms, pairapprox = TRUE, meanfield = FALSE, "L", c(0,12), add =TRUE)-> out_5

parms$f = 0
bifurcation(parms, pairapprox = TRUE, meanfield = FALSE, "L", c(0,12), add =TRUE)-> out_6
