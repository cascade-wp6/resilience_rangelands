...
```{r, echo=FALSE}
defplot(rho,  C(rho, m = parms$m, L = parms$L, h = parms$h, a = parms$a ) )
...
odesys_spex <- function(t, rho, parms) {
...
par(mfrow= c(1,2), bty = "n", mar = c(4,4,1,0))
...
plot(rho_1 ~ b, data = cbind(output, iterations), type = "p", pch  = 20, ylim = c(0,1), cex = 0.5)
...
plot(rho_1 ~ L, data = cbind(output, iterations), type = "p", pch  = 20, ylim = c(0,1), cex = 0.5)
