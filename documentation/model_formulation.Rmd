...
$$ w_{1,0} = m + ( a^*  + v q_{1|1})L\rho_1^{q}{1+( a^*  + v q_{1|1})(h^*/ (1 - p  q_{1|1}))\rho_1^{1+q}} $$

$$ w_{0,1} = \frac{r \rho_1^{1+\alpha} (b^* + (f - b^*) q_{0|1}) (1-\frac{\rho_1}{K^* (1 - c q_{0|1})})}{1-\rho_1} $$
...
$$  \frac{\mathrm{d}\rho_11}{\mathrm{d}t} = 2 \rho_{10} \frac{r \rho_1^{1+\alpha} (b^* + (f - b^*) q_{0|1}) (1-\frac{\rho_1}{K^* (1 - c q_{0|1})})}{1-\rho_1} - 2 \rho_{11} m -  2 \rho_{11} \frac{(a^*  + v q_{1|1})L\rho_1^{q}}{1+(a^*  + v q_{1|1})(h^*  / (1 - p  q_{1|1}))\rho_1^{1+q}}  $$

$$  \frac{\mathrm{d}\rho_{1}}{\mathrm{d}t} = \rho_{0}\frac{r \rho_1^{1+\alpha} (b^* + (f - b^*) q_{0|1}) (1-\frac{\rho_1}{K^* (1 - c q_{0|1})})}{1-\rho_1} - \rho_{1}m - \frac{(a^*  + v q_{1|1})L\rho_1^{1+q}}{1+(a^*  + v q_{1|1})(h^*  / (1 - p  q_{1|1}))\rho_1^{1+q}}   $$
...
$$  \frac{\mathrm{d}\rho_{1}}{\mathrm{d}t} = r \rho_1^{1+\alpha} (b^* + (f - b^*) q_{0|1}) (1-\frac{\rho_1}{K^* (1 - c q_{0|1})}) - \rho_{1}m - \frac{(a^*  + v q_{1|1})L\rho_1^{1+q}}{1+(a^*  + v q_{1|1})(h^*  / (1 - p  q_{1|1}))\rho_1^{1+q}}   $$
...
$$  \frac{\mathrm{d}\rho_{11} }{\mathrm{d}t} = 2 (\rho_1 - \rho_{11}) \frac{r \rho_1^{1+\alpha} (b^* + (f - b^*) \frac{\rho_{1} - \rho_{11}}{1 - \rho_1}) (1-\frac{\rho_1}{K^* (1 - c \frac{\rho_{1} - \rho_{11}}{1 - \rho_1})})}{1-\rho_1} - 2 \rho_{11} m -  2 \rho_{11} \frac{(a^*  + v \frac{\rho_{11}}{\rho_1})L\rho_1^{q}}{1+(a^*  + v \frac{\rho_{11}}{\rho_1})(h^*  / (1 - p  \frac{\rho_{11}}{\rho_1}))\rho_1^{1+q}}  $$

$$  \frac{\mathrm{d}\rho_{1}}{\mathrm{d}t} = r \rho_1^{1+\alpha} (b^* + (f - b^*) \frac{\rho_{1} - \rho_{11}}{1 - \rho_1}) (1-\frac{\rho_1}{K^* (1 - c \frac{\rho_{1} - \rho_{11}}{1 - \rho_1})}) - \rho_{1}m -  \frac{(a^*  + v \frac{\rho_{11}}{\rho_1})L\rho_1^{1+q}}{1+(a^*  + v \frac{\rho_{11}}{\rho_1})(h^*  / (1 - p  \frac{\rho_{11}}{\rho_1}))\rho_1^{1+q}}   $$

Thus, we can solve the ODE for a given set of parameters
...
parms <- list(
    ...
    p = 0.2, # protection effect
    L = 4, # livestock units per landscape unit 
