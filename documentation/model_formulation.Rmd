...
par(mfrow = c(1,2))
parms$q = 0.4
bifurcation(parms, "L", c(0,12)) -> over_L
...
```{r, echo=FALSE, fig.height = 3}
par(mfrow = c(1,2))
bifurcation(parms, "L", pairapprox = TRUE, meanfield = FALSE, c(0,12)) -> over_L
 
bifurcation(parms,"b", pairapprox = TRUE, meanfield = FALSE, c(0,1)) -> over_b
...
par(mfrow =c(1,2))
  plot(over_b$pairapprox$b, over_b$pairapprox$rho_1, pch = 20,  cex = 0.5, ylim = c(0,1), xlim = c(0,1))
